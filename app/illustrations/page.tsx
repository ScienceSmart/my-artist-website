      ...
      <div className="flex min-h-screen">
        ...
        <main className="container flex-1 flex-col px-10 py-4 justify-left bg-main text-black ">
          <div className="flex-row bg-white p-5 my-5 border-4 border-gray-600 rounded-md shadow-lg">
            <h1 className="text-3xl">Oil Paintings</h1>
          </div>
          <div className="flex-row bg-white p-5 my-5 border-4 border-gray-600 rounded-md shadow-lg">
            <h1 className="text-3xl">Acrylic Paintings</h1>
            

          </div>
          <div className="flex-row bg-white p-5 my-5 border-4 border-gray-600 rounded-md shadow-lg">
            <h1 className="text-3xl">Watercolor Paintings</h1>
            

          </div>
          <div className="flex-row bg-white p-5 my-5 border-4 border-gray-600 rounded-md shadow-lg">
            <h1 className="text-3xl">Charcoal</h1>
            

          </div>
          <div className="flex-row bg-white p-5 my-5 border-4 border-gray-600 rounded-md shadow-lg">
            <h1 className="text-3xl">Pen and Ink</h1>
            

          </div>
          <div className="flex-row bg-white p-5 my-5 border-4 border-gray-600 rounded-md shadow-lg">
            <h1 className="text-3xl">Background Art</h1>
